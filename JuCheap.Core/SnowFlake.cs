...
* Name : 分布式ID生成算法
* Description: 核心思想是：一个long型的ID，使用其中41bit作为毫秒数，10bit作为机器编号，12bit作为毫秒内序列号。这个算法单机每秒内理论上最多可以生成1000*(2^12)，也就是400W的ID
* 
* Revision History:
...
namespace JuCheap.Core
{
    ...
    public class SnowFlake
    {
        ...
        public static string NewId()
        {
            ...
            var snowId = _sigle.NextId();

            return string.Format("{0}{1}", DateTime.Now.ToString("yyyyMMddHHmmss"), snowId);
        }
