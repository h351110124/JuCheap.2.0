...
namespace JuCheap.Service
{
    ...
    public partial class AutoMapperConfiguration
    {
        ...
        public static void Config()
        {
			...
			Mapper.CreateMap<CarEntity, CarDto>();
			Mapper.CreateMap<CarDto, CarEntity>();
			...
			Mapper.CreateMap<GonggaoEntity, GonggaoDto>();
			Mapper.CreateMap<GonggaoDto, GonggaoEntity>();

			Mapper.CreateMap<GongziEntity, GongziDto>();
			Mapper.CreateMap<GongziDto, GongziEntity>();
			...
			Mapper.CreateMap<NoticeEntity, NoticeDto>();
			Mapper.CreateMap<NoticeDto, NoticeEntity>();
